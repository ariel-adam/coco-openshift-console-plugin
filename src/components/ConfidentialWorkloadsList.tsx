        ...
        {!loaded ? (
          ...
          >
            <EmptyStateBody>
              {workloads.length === 0
                ? t(
                    'Confidential workloads use a kata-cc runtime class (bare-metal TEE) or kata-remote (cloud peer-pod). Deploy one with runtimeClassName: kata-cc or kata-remote to see it here.',
                  )
